...
import classes from "./chusershandle.module.scss";
...
const ChUsersHandle = () => {
    ...
    useEffect(() => {
        ...
        console.log("in get channel users => ",chatsToShow,token);
        fetcher("POST", "Channels/GetChannelUsers", data, token)
            .then((r) => r)
